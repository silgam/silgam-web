  ...
  return (
    <div className="footer">
        <div className='logo-row'>
          <a href='http://pf.kakao.com/_Vmxjxbxj' target='_blank' rel="noreferrer"><img src={supportLogo} alt='support-logo'/></a>
          <a href='https://open.kakao.com/o/gS4s3HFe' target='_blank' rel="noreferrer"><img src={kakaotalkLogo} alt='kakaotalk-logo'/></a>
