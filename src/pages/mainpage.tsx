        ...
        <main className='mainpage-main'>
          ...
          <section>
            <div className="section-desc-area">
              <img className={showFirstSection ? 'mockup-img-visible' : 'mockup-img-invisible'} src={simulationPageMockup} alt="mockup-simulation" />
          ...
          <section>
            <div className="section-desc-area">
              ...
              <img className={showSecondSection ? 'mockup-img-visible' : 'mockup-img-invisible'} src={noiseSettingPageMockup} alt="mockup-noise" />
            </div>
          </section>
          <section>
            <div className="section-desc-area">
              <img className={showThirdSection ? 'mockup-img-visible' : 'mockup-img-invisible'} src={simulationPageMockup} alt="mockup-timetable" />
              <div className={showThirdSection ? 'description-area-right' : 'description-area-right-invisible'}>
                <h1>전과목 연속 응시</h1>
                <h4>전과목 실전 모의고사를 한 번에 연습하는 날, 실감과 함께 하루 종일 실전과 같은 감각을 유지할 수 있습니다.</h4>
              </div>
            </div>
          </section>
          <section>
            <div className="section-desc-area">
              <div className={showFourthSection ? 'description-area-left' : 'description-area-left-invisible'}>
                <h1>피드백과 통계</h1>
                <h4>시험이 끝나면 모의고사에 대한 피드백을 바로 기록하고, 응시한 모의고사들에 대한 통계를 확인할 수 있어요.</h4>
              </div>
              <img className={showFourthSection ? 'mockup-img-visible' : 'mockup-img-invisible'} src={feedbackPageMockup} alt="mockup-feedback" />
            </div>
          </section>
        </main>
      </div>
    ...
    return (
      <div className="mainpage">
        ...
        <main className='mainpage-main'>
          <section>
            <div className="section-main-area">
              <h2 className="sub-title">시험장의 변수때문에 1년의 노력이 헛되지 않게</h2>
