      ...
      <main className="mainpage-main">
        ...
        <section>
          <div className="section-desc-area">
            <img
              className={
                showFirstSection ? "mockup-img-visible" : "mockup-img-invisible"
              }
              src={simulationPageMockup}
              alt="mockup-simulation"
            />
            ...
            >
              <h1>시험장 시뮬레이션</h1>
              <h4>
                과목별 시험 시간에 맞춰 표시되는 아날로그 시계와, 실제 시험장과
                동일한 타종 소리로 현장감을 극대화할 수 있습니다.
              </h4>
            </div>
          </div>
        </section>
        <section>
          <div className="section-desc-area">
            ...
            >
              ...
              <h1>랜덤재생 소음 ASMR</h1>
              <h4>
                글씨 쓰는 소리, 기침 소리, 다리 떠는 소리, 의자 움직이는 소리...
                랜덤으로 재생되는 소음의 빈도를 조절하며 다양한 난이도로 실전
                모의고사를 연습해보세요.
              </h4>
            </div>
          </div>
        ...
        <section>
          <div className="section-desc-area">
            <img
              className={
                showThirdSection ? "mockup-img-visible" : "mockup-img-invisible"
              }
              src={simulationPageMockup}
              alt="mockup-timetable"
            />
